...
/// WebSocket地址
//const String _SOCKET_URL = 'wss://118.31.169.131:2341';
const String _SOCKET_URL = "ws://echo.websocket.org";
/// WebSocket状态
enum SocketStatus {
...
class WebSocketUtility {
  ...
  void openSocket() {
    ...
    headers['tag'] = 2;
    headers['encryption'] = 1;
    headers['selfVerify'] = 1;
    headers['User-Agent'] = "Jin10 Android Client(v 5.1.0)";
    headers['Connection'] = "close";
    headers['x-version'] = "1.0.0";
    headers['x-app-id'] = "g93rhHb9DcDptyPb";
    headers['x-udid'] = "fed9487668184bc29002d6437cf3d163";
    headers['x-token'] = "";
    headers['x-app-ver'] = "android_base_5.1.0.445";
    _webSocket = IOWebSocketChannel.connect(_SOCKET_URL,headers: headers);
  ...
  webSocketOnError(e) {
    ...
    print('WebSocket连接错误: ${ex.message}');
    onError(ex.message);
    closeSocket();
  }
